...
class Jogo:
    ...
    def _inicializar_mapa(self, active_colors: list[Cor]) -> Mapa:
        ...
        all_cities_data = [
            ...
            ("Chenai", Cor.PRETO),
            ("Chicago", Cor.AZUL),
            ("Cidade de Ho Chi Minh", Cor.VERMELHO),
        ...
        all_connections = [
            ...
            ("Bagdá", "Karachi"), ("Bagdá", "Teerã"), ("Bagdá", "Riad"),
            ("Bangkok", "Calcutá"), ("Bangkok", "Cidade de Ho Chi Minh"),
            ("Bogotá", "São Paulo"), ("Bogotá", "Lima"), 
            ("Buenos Aires", "São Paulo"), ("Buenos Aires", "Bogotá"),
            ("Cairo", "Bagdá"), ("Cairo", "Riad"), ("Cairo", "Istambul"),
            ("Chenai", "Calcutá"), ("Chenai", "Jacarta"), ("Chenai", "Bangkok"),
            ...
            ("Deli", "Teerã"), ("Deli", "Karachi"), ("Deli", "Chenai"), ("Deli", "Calcutá"),
            ("Essen", "São Petersburgo"),
            ("Hong Kong", "Bangkok"), ("Hong Kong", "Cidade de Ho Chi Minh"), ("Hong Kong", "Calcutá"), ("Hong Kong", "Manila"), ("Hong Kong", "Taipé"),
